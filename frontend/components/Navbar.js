      ...
      <div className="bg-indigo-900 text-white">
       <div className="max-w-7xl mx-auto px-4 py-3 sm:py-4 flex flex-wrap items-center gap-2 sm:gap-4">
          ...
          <form
            ...
            className="flex-1 max-w-2xl hidden sm:flex items-center bg-white rounded-full shadow-md pr-1.5 focus-within:ring-2 focus-within:ring-marigold-400"
          >
            <input
              type="text"
              value={query}
            ...
            <button
              type="submit"
              className="bg-gradient-to-br from-marigold-400 to-marigold-600 w-10 h-10 rounded-full flex items-center justify-center text-white shadow-md focus-ring shrink-0"
              aria-label="Search"
            >
              <svg
  ...
  >
    ...
    {itemCount > 0 && (
      <span className="absolute -top-2 -right-2 bg-white text-indigo-900 text-xs font-extrabold rounded-full w-6 h-6 flex items-center justify-center border-2 border-marigold-500">
        ...
        <form
          onSubmit={handleSearch}
          className="sm:hidden px-4 pb-3 flex shadow-md"
        >
          <input
            type="text"
            value={query}
          ...
          <button
            type="submit"
            className="bg-marigold-400 px-5 rounded-r text-white font-bold"
          >
            Go
          </button>
        </form>
